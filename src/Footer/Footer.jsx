        ...
        <div className="Footer">
                ...
                <div className="center">
                    <div className="left">
                        ...
                        <p id="main_p">With ver two decades, we are bringing international teaching standards to the tech aspirants globally. Nurture your inner coder with us
                            and take a charge of your coding career with the top trending and high paying technologies. This is the right time to enlighten your code "GNAN".
                        </p>
                    ...
                    <div className="populated">
                        ...
                        <span><Link className="foot_men" to="/Blog">Blogs</Link></span>
                        <span><Link className="foot_men" to="/about-us">About us</Link></span>
                        <span><Link className="foot_men" to="/internships">Internships</Link></span>
                        <span><Link className="foot_men" to="/placements">Placements</Link></span>
                        {/* <span><Link className="foot_men" to="#">Become a mentor</Link></span> */}
                        <span><Link className="foot_men" to="/job_accelerator_program">Job acceleration program</Link></span>
            ...
            <section className="our_courses">
                <div className="courses">
                    ...
                    <Link to="/python-training-in-vijayawada">Python Training in Vijayawada</Link><br />
                    <Link to="/python-full-stack-developer-course-in-vijayawada">Python full-stack course Vijayawada</Link><br />
                    <Link to="/data-science-course-training-in-vijayawada">Data science training in Vijayawada</Link><br />
                    <Link to="/machine-learning-course-training-in-vijayawada">Machine learning in Vijayawada</Link><br />
                    <Link to="/react-js-training-course-in-vijayawada">React JS training in Vijayawada</Link><br />
                    <Link to="/data-structures-and-algorithms-training-in-vijayawada">Data structures course in Vijayawada</Link><br />
                    <Link to="/c-programming-course-training-in-vijayawada">C programming course in Vijayawada</Link>
                </div>
                <div className="courses">
                    <h3>Our courses in Hyderabad </h3><br />
                    <Link to="/python-training-course-in-hyderabad">Python training in Hyderabad</Link><br />
                    <Link to="/python-full-stack-developer-course-in-hyderabad">Python full-stack training in Hyderabad</Link><br />
                    <Link to="/core-java-training-course-in-hyderabad">Core Java training in Hyderabad</Link><br />
                    <Link to="/java-full-stack-training-course-in-hyderabad">Java full-stack course in Hyderabad</Link><br />
                    <Link to="/data-science-course-training-in-hyderabad">Data science training in Hyderabad</Link><br />
                    <Link to="/machine-learning-course-training-in-hyderabad">Machine learning course in Hyderabad</Link><br />
                </div>
                <div className="courses">
                    <h3>Our courses in Bangalore </h3><br />
                    <Link to="/python-training-in-bangalore">Python training in Bangalore</Link><br />
                    <Link to="/python-full-stack-developer-course-in-bangalore">Python full-stack training in Bangalore</Link><br />
                    <Link to="/core-java-training-course-in-bangalore">Core Java training in Bangalore</Link><br />
                    <Link to="/java-full-stack-training-course-in-bangalore">Java full-stack course in Bangalore</Link><br />
                </div>
            </section><br /><br />
            <div className="footer_end">
                ...
                <br />
                <p>
                    <Link to="/privacy-policy">Privacy Policy</Link> | <Link to="/terms-conditions">Terms and Conditions</Link> | <Link to="/refund-policy">Refund Policy</Link> | <Link to="/cancellation-policy">Cancellation Policy</Link>
                </p>
            </div>
        </div>
    );
