...
const syllabusdata = [
    {
        ...
        p: (
            <>
                <h2 style={{ color :"black" }}>Python Full Stack course <span style={{ color :"red" }} > curriculum in Bangalore </span></h2><br />
...
const syllabus2data = [
    {
        ...
        p: (
            <>
            <h2 style={{ color :"black" }}>Python Full Stack Development <span style={{ color :"red" }} >Skills Covered in Bangalore </span></h2><br />
                <p>After completing our Python full stack development, you will gain a better understanding of how to create an end-to-end application, cloud based deployment and debugging among others. Some of the top core competencies you will be equipped with include:</p>
                <ul>
                    {[
