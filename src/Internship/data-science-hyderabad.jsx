...
const syllabusdata = [
    {
        ...
        p: (
            <>
                <h2 style={{ color :"black" }}>Data Science Training <span style={{ color :"red" }} > Curriculum in Hyderabad </span></h2><br />
            ...
            <div className="intern-home3">
                <div className="intern-home-form">
                    ...
                    <div className="intern_from">
                        ...
                        <p>Talk to our expert Best Data Science mentors and learn how our training programs in Hyderabad can help you become a Best Data Science developer and get a high-paying job. </p><br /><br />
                        <FormComponent />
                    </div>
                </div>
            </div><br /><br />
