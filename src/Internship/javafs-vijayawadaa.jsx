...
const syllabusdata = [
    {
        ...
        p: (
            <>
                <h2 style={{ color :"black" }}>Full Stack Java Developer  <span style={{ color :"red" }} > Course Curriculum in Vijayawada </span></h2><br />
...
const syllabus2data = [
    {
        ...
        p: (
            <>
            <h2 style={{ color :"black" }}>Java Skills <span style={{ color :"red" }} > Covered in Vijayawada </span></h2><br />
            <p>You will be able to incorporate all of the database connection techniques in this course, along with acquiring the skills to make it visually appealing and useful. Once you have mastered Java, we will explore JSP and Servlets, and then go on to Hibernate. After discussing the fundamentals of technology, we’ll discuss one of the most well-liked Java frameworks: Spring. The topics we will cover are the Restful web services, Spring Boot, and the Spring framework.</p>
            <p>Training outcomes: </p>
                <ul>
                    {[
                        "Strong foundation in Java programming, object-oriented principles, exception handling, and multi-threading.",
                        "Proficiency in using Java libraries and tools.",
                        "Understanding of the basics of relational databases.",
                        "Practical experience in web development with Java Server Pages (JSPs) and Object-Relational Mapping (ORM) using Hibernate.",
                        "Familiarity with the principles of microservices and DevOps.",
                        "Well-rounded understanding of full-stack Java development.",
                        "Ability to design and develop robust Java-based applications.",
                        "Understanding of software design patterns for efficient and maintainable code.",
                        "Introduction to the Spring framework, etc."
                    ].map((item, index) => (
            ...
            <div className="intern-home3">
                <div className="intern-home-form">
                    ...
                    <div className="intern_from">
                        ...
                        <p>Talk to our expert Java Full Stack and learn how our training programs in Vijayawada can help you become a Java Full Stack developer and get a high-paying job. </p><br /><br />
                        <FormComponent />
                    </div>
                </div>
            </div><br /><br />
