...
const  data2 = [
  ...
  },
  {
    ...
    <p> Hands-On Execution of all types operators and explain how expressions are simplified.</p>
    </>
    )
  },
  {
  ...
  },
  {
    ...
    <>
      <ul>
          <li> menu() – This function shows a menu or welcome screen that allows you to execute the various banking tasks listed below.</li>
          <li> new acc() – Creates a new customer account using this function. It requests the customer’s name, date of birth, citizenship number, address, and phone number, among other personal and financial information.</li>
          <li> view list() – Displays a list of items. This feature allows you to access the customer’s banking information, including the account number, name, address, and phone number supplied when the account was created.</li>
          <li> edit() – This method has been used to update the address and phone number associated with a specific customer account.</li>
          <li>  transact() – This method allows you to deposit and withdraw funds from a specific client account.</li>
      </ul>
    </>
    )
  }
