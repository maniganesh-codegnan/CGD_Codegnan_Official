...
const syllabusdata = [
    {
        ...
        p: (
            <>
                <h2 style={{ color :"black" }}>Full Stack Java developer <span style={{ color :"red" }} >course curriculum in Hyderabad </span></h2><br />
...
const syllabus2data = [
    {
        ...
        p: (
            <>
            <h2 style={{ color :"black" }}>Java Skills <span style={{ color :"red" }} > Covered in Hyderabad </span></h2><br />
            <p>After completing codegnan’s Java Full Stack training in Hyderabad, here are the skills you will develop.</p>
                <ul>
                    {[
            ...
            <div className="intern-home3">
                <div className="intern-home-form">
                    ...
                    <div className="intern_from">
                        ...
                        <p>Talk to our expert Java mentors and learn how our training programs in Hyderabad can help you become a Java developer and get a high-paying job. </p><br /><br />
                        <FormComponent />
                    </div>
                </div>
            </div><br /><br />
