...
const syllabusdata = [
    {
        ...
        p: (
            <>
                <h2 style={{ color :"black" }}>Python Full stack development <span style={{ color :"red" }} > Training curriculum in Vijayawada </span></h2><br />
...
const syllabus2data = [
    {
        ...
        p: (
            <>
            <h2 style={{ color :"black" }}>Python Full Stack Development <span style={{ color :"red" }} >Skills Covered in Vijayawada </span></h2><br />
                <p>After completing this comprehensive Python full-stack development course by codegnan, here are some skills you’ll leave with.</p>
                <ul>
                    {[
            ...
            <div className="intern-home3">
                <div className="intern-home-form">
                    ...
                    <div className="intern_from">
                        ...
                        <p>Talk to our expert Python mentors and learn how our training programs in Vijayawada can help you become a Full Stack Python developer and get a high-paying job. </p><br /><br />
                        <FormComponent />
                    </div>
                </div>
            </div><br /><br />
