...
const syllabusdata = [
    {
        ...
        p: (
            <>
                <h2 style={{ color :"black" }}>Java Training Course <span style={{ color :"red" }} > Curriculum In Hyderabad </span></h2><br />
...
const syllabus2data = [
    {
        ...
        p: (
            <>
            <h2 style={{ color :"black" }}>Hands-on projects <span style={{ color :"red" }} > covered in our Java training in Hyderabad </span></h2><br />

            <p>At codegnan you learn through application. So you will be working on and off on different small scale projects to apply what you are learning.</p>
            <p>Since the course duration is short, you will be working on these projects simultaneously. Here are some project topics you can expect to work on.</p>
                <ul>
                    {[
                            "Hello Java world",
            ...
            <div className="intern-home3">
                <div className="intern-home-form">
                    ...
                    <div className="intern_from">
                        ...
                        <p>Talk to our expert Java mentors and learn how our training programs in Hyderabad can help you become a Full Stack Java developer and get a high-paying job.</p><br /><br />
                        <FormComponent />
                    </div>
                </div>
            </div><br /><br /><br />
