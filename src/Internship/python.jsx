...
const syllabusdata = [
    {
        ...
        p: (
            <>
                <h2 style={{ color :"black" }}>Python Training course <span style={{ color :"red" }} > Curriculum In Bangalore </span></h2><br />
...
const syllabus2data = [
    {
        ...
        p: (
            <>
            <h2 style={{ color :"black" }}>Skills covered in our <span style={{ color :"red" }} > Python training institute in Bangalore </span></h2><br />
            {/* <Inter_dropdown data={data2} /> */}
                <p>Upon completion of Codegnan’s intensive Python training in Bangalore, you will be equipped with a versatile Python array of skills, which include:</p>
                <ul>
                    {[
    ...
    {
        head: "Fundamentals of Python:",
        p: (
            <>
                <ul>
                    {[
                        " This includes setting up the environment, syntax, operators, data structures, dictionaries and much more by utilizing Python."
                    ].map((item, index) => (
                        <li key={index} style={{ marginLeft: "10px" }}>{item}</li>
                    ))}
                </ul>
    ...
    {
        head: " Object Oriented Programming (OOPs): ",
        p: (
            <>
                <ul>
                    {[
                        "You will get a chance to be familiarized with classes, objects, inheritance, polymorphism and operator overloading."
                    ].map((item, index) => (
                        <li key={index} style={{ marginLeft: "10px" }}>{item}</li>
                    ))}
                </ul>
    ...
    {
        head: " Python for Data Analysis: ",
        p: (
            <>
                <ul>
                    {[
                        " Working on packages like Numpy, Pandas and Matplotlib, you will learn all about web scraping, and data analysis & visualization with Python. Sqlite3 and MySQL will further allow you to dive deep into the world of database access."
                    ].map((item, index) => (
                        <li key={index} style={{ marginLeft: "10px" }}>{item}</li>
                    ))}
                </ul>
    ...
    {
        head: " Python for Web Development :",
        p: (
            <>
                <ul>
                    {[
                        "Not only will you get introduced to APIs, you will gain practical experience working with Python Web Framework Flask for web development."
                    ].map((item, index) => (
                        <li key={index} style={{ marginLeft: "10px" }}>{item}</li>
                    ))}
                </ul>
    ...
    },
    {
        ...
        p: (
            <>
                <ul>
                    {[
                        "Opportunity to work on a variety of use cases and assignments at the end of each module will make sure that you are job ready even before stepping into the real world."
                    ].map((item, index) => (
                        <li key={index} style={{ marginLeft: "10px" }}>{item}</li>
                    ))}
                </ul>
