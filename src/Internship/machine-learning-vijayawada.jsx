...
const syllabusdata = [
    {
        ...
        p: (
            <>
                <h2 style={{ color :"black" }}>Machine Learning course <span style={{ color :"red" }} > Curriculum in Vijayawada </span></h2><br />
...
const syllabus2data = [
    {
        ...
        p: ( 
            <>
            <h2 style={{ color :"black" }}>Tools You Will Learn with <span style={{ color :"red" }} > Our Machine Learning Course in Vijayawada </span></h2><br />

                <p>What tools you master in your course is very important in assessing your skills. So, to give you a brief idea, here are some of the tools you’ll learn to use during this machine learning course in Vijayawada by codegnan. </p>
                <ul>
                    {[
            ...
            <div className="intern-home3">
                <div className="intern-home-form">
                    ...
                    <div className="intern_from">
                        ...
                        <p>Talk to our expert Machine Learning mentors and learn how our training programs in Vijayawada can help you become a Machine Learning developer and get a high-paying job.</p><br /><br />
                        <FormComponent />
                    </div>
                </div>
            </div><br /><br />
