...
const syllabusdata = [
    {
        ...
        p: (
            <>
                <h2 style={{ color :"black" }}>Python Training course <span style={{ color :"red" }} > curriculum in Hyderabad </span></h2><br />
...
const syllabus2data = [
    {
        ...
        p: (
            <>
            <h2 style={{ color :"black" }}>Skills covered in our <span style={{ color :"red" }} >  Python training institute in Hyderabad </span></h2><br />
            {/* <Inter_dropdown data={data2} /> */}
                <p>You can use Python to develop workflows and improve data analysis rather than only for software development like most other programming languages. Anyone willing to start as a coder can learn Python as it is easy to grasp its simple English syntax. Once you complete Codegnan’s Python course, you will gain multiple skills including</p>
                <ul>
                    {[
