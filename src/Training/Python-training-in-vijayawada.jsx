import Training_template from "./Training_template.jsx";
import { Helmet } from 'react-helmet';
import Python_Vijayawada from '../Internship/python-vijayawada.jsx'
import Python_Faq_Vijayawada from '../faqs/python_faq_vijayawada.jsx';
...
const headData = {
  ...
  const curriculumData = <Python_Vijayawada /> 
...
export default function Python_training_in_Vijayawada() {
    return (
        <div>
            <Helmet>
                <title>⭐ Best Python Course In Vijayawada (#1 Institute) </title>
