        ...
        <div className='tth'>
            ...
            <div className='training_template_headerdetails'>
                <div className='course_head_details'>
                    ...
                    <br /><br />
                    <h3><a href="#"><u>Click here to get team discount</u> </a></h3>
...
export default function Training_template(props) {
    ...
    useEffect(() => {
        const offerEndTime = new Date(); // Set your offer end time here
        offerEndTime.setHours(offerEndTime.getHours() + 6); 
        offerEndTime.setMinutes(offerEndTime.getMinutes() + 60); // Example: Offer ends in 30 minutes

        const updateCountdown = () => {
            const currentTime = new Date().getTime();
            const distance = offerEndTime - currentTime;

            const hours = Math.floor((distance % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
            const minutes = Math.floor((distance % (1000 * 60 * 60)) / (1000 * 60));
            const seconds = Math.floor((distance % (1000 * 60)) / 1000);

            setOfferEndsIn(`${hours}h ${minutes}m ${seconds}s`);

            if (distance < 0) {
                clearInterval(interval);
                setOfferEndsIn("Offer Ended");
            }
        };
        ...
        <div className='tth'>
            ...
            <div className='training_template_headerdetails'>
                <div className='course_head_details'>
                    ...
                    <br /><br />
                    <h3><a href="#"><u>Click here to get team discount</u> </a></h3>
                    <p className='offer'>Offer Ends in </p> {/* Display countdown */}
                    <h2>{offerEndsIn}</h2>
