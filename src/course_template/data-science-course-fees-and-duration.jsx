...
import datasciencecoursedurationfees_projects from '/course_images/Data-science-course-duration-and-fees-illustration-by-codegnan.png';
import { Link } from "react-router-dom";
import { Helmet } from 'react-helmet';

const headdata = {
    title: "Data Science Course Fees and Duration in India [2024]",
    date:  "July 25, 2024",
    img:   datasciencecoursedurationfees_projects ,
    intro: "Data science course fees in India range from ₹2,00,000 to ₹8,00,000 in 2024 if you opt for academic qualifications such as B.Tech, M.Tech, and so on. \n The data science course duration is typically 2-4 years, with BCA and B.Sc. programs taking 3-4 years, while M.Sc. and M.Tech. programs last about 2 years. \n Shorter data science certification courses are also available, lasting 6-12 months."
};

const coursedata = {
    title: "⭐ For example: ",
    p: " Codegnan’s 6-month long data science course fee is around ₹75,000 which gives you career support and learning experience through real-world data science projects. \n Various factors affect the <b> data science course fees and duration</b> such as course level, institution, placement support and delivery mode.",
    linkText: " ",
    syllabusLink: "",
};
...
const courseSections = [
    ...
    {
        title: "What’s covered in this guide",
        intro: " ",
        content: [
...
const course_brief = [
    {
        intro: () => (
            <>
                ...
                <ul>
                    {[
                        { name: "Data science course fees", link: "/" },
                        { name: "Data science course duration ", link: "/" },
                        { name: "Data science course eligibility", link: "/" },
                        { name: "Why you should enroll in Codegnan’s 6-month data science course", link: "/" }
    ...
    {
        title: "Data science course fees",
        intro: () => (
            <>
                <h2>How much does a data science course cost in 2024? </h2>
                <p>Data Science course costs around ₹2,00,000 – ₹8,00,000 in 2024. However, you can also find some low-cost or premium courses with different fee structures. </p>
                <p> Multiple reasons will affect data science course costs in 2024.</p>
            </>
        )
    },
    {
        ...
        intro: " <ul> "+
                [    
                    "<b> Type of course:</b> BCA, BSc, MSc, BTech, MTech",
                    "<b> Level of course:</b> Undergraduate program, Postgraduate program, executive program ",
                    "<b> Course duration:</b> short-term courses, long-term degree courses, certification course",
                    "<b> Mode of course delivery:</b> Online training, Classroom session, self-paced learning",
                    "<b> Availability of additional facilities:</b> Placement Assistance, Internship opportunities, working on live data science projects",
                    "Reputation of the institution and its location",
                    "<b> Type of institution:</b> Public University, Deemed University, Academic Institution, Community College "
                ].map((item, index) => (
    ...
    },
    {
        ...
        intro: () => (
            <>
                <h2>👉 Click here to download the full data science syllabus </h2>
            </>
        )
    },
    {
        title: "How much does a data science classroom training course cost? ",
        intro: () => (
            <>
                <p> The cost of a data science course typically ranges from ₹74,999 to ₹8,00,000.</p>
                <p> However, Codegnan’s data science classroom training course costs around ₹74,999. It offers a six-month comprehensive data science training program and provides students with industry-approved certification.</p>
                <img src="/syllabuspages/data1.png" alt="error" />
            </>
        )
    },
    {
...
export default function JavaCoursePage() {
    return (
        <div>
            <Helmet>
                <title>Data Science Course Fees and Duration in India [2024]</title>
                <meta name="description" content="Data science course fees in India range from ₹2,00,000 to ₹8,00,000 in 2024 if you opt for academic qualifications such as B.Tech, M.Tech, and so on. The data science course duration is typically 2-4 years, with BCA and B.Sc. programs taking 3-4 years, while M.Sc. and M.Tech. programs last about 2 years. Shorter data science" />
            </Helmet>
