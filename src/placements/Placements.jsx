...
import photo_1 from './Photos/1.webp';
...
// import MainComponent from './PhotoComponent';

export default function Placements() {
    return (
        <div>
            <div className="Placements">
                <h2><span>Our Placement Team Will Help To Shape</span> Your Career Opportunities</h2>
            </div>
