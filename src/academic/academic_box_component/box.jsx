...
export default function Box({ box_content }) {
    ...
    return (
        <div className='box_container'>
            ...
            <Link to={box_content.headlinklink} className='Linkcolor' onClick={scrollToTop}><h2>{box_content.headlink}</h2></Link>
           <span><b>Trainer :</b> {box_content.trainer} ;  &nbsp;&nbsp;<b>Price :</b> {box_content.price}</span><br /><br />
            ...
            <Link className='explore-button' to={box_content.buttonlink} onClick={scrollToTop}>Start Course</Link>&nbsp;&nbsp;
