        ...
        <div className="our_collaborations">
            ...
            <div>
              ...
              <div className="div_container_notch_team">
                <div className="div_container_notch_team_section1">
                  <ul>
                    <li>
                      <span className="check">&#x2713;</span>Embark on a Journey
                      with Elite Mentors - IIT Alumni and Top MNC Experts.
                    </li>
                    <li>
                      <span className="check">&#x2713;</span>Experience
                      Doubt-Free Learning from Product Developers.
                    </li>
                    <li>
                      <span className="check">&#x2713;</span>Elevate Your Skills
                      with Expert Masterclasses.
                    </li>
                  </ul>
                </div>
          ...
          {/* <div className="Our_training_center">
            <center>
              {" "}
              <h2>
                Our Training <span className="change_color">Campuses</span>
              </h2>
            </center>
            <div className="div_container_training_center">
              <div className="center_details">
                ...
                <h3>
                  Vijayawada training{" "}
                  <span className="change_color">centre</span>
                </h3>
                <p>
                ...
                <p>
                  Visit our{" "}
                  <a href="/vijayawada_campus" className="campus_link">
                    Vijayawada Campus
                  </a>
                </p>{" "}
                <br />
              ...
              <div className="center_details">
                ...
                <p>
                  Kothwal Madhava Reddy Plaza, Near JNTUH Metro Station,
                  Nizampet X Roads, Hyderabad, 500072.
                </p>
                <p>
                  Visit our{" "}
                  <a href="/hyderabad_campus" className="campus_link">
                    Hyderabad Campus
                  </a>
                </p>
              </div>
              <div className="center_details">
                ...
                <h3>
                  Banglore training <span className="change_color">centre</span>
                </h3>
                <p>
                ...
                <p>
                  Visit our{" "}
                  <a href="/bangalore_campus" className="campus_link">
                    Banglore Campus
                  </a>
                </p>
              </div>
          ...
          <div className="our_collaborations">
            <center>
              <h1 className="change_color">
                Video Testimonials <span> of Our Students </span>{" "}
              </h1>
              <br />
              <br />
              <Video_Testimonials />
